        ...
        <div class="pull-left">
            ...
            <?php
                ...
                if($createComment && $userPermissionType != "view") {
                   ...
                   echo "<div><a href="."'http://localhost/training/web/ticket_tracker/index.php?action=viewTicket&id=".$ticketId."&addComment=true'"."><button class="."'btn comment'".">Add comment</button></a></div>";
                }
            ?>
